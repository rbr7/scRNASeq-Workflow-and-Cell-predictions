...
embs = embex.extract_embs("../fine_tuned_models/geneformer-6L-30M_CellClassifier_cardiomyopathies_220224",
                          ...
                          "output_prefix")
'''
# embs = embex.extract_embs("/lus/grand/projects/GeomicVar/rbr7/Geneformer/cancer_train/models/230910_102418_geneformer_30M_L6_emb256_SL2048_E10_B12_LR0.001_LSlinear_WU10000_Oadamw_DS8/checkpoint-439712/", "/grand/GeomicVar/rbr7/Geneformer/cancer_cellxgene_datasets/cancer_corpus/combined_6M_shuffled.dataset/", "./output_trained","breast_cell_type")
embs = embex.extract_embs("/lus/grand/projects/GeomicVar/rbr7/Geneformer/cancer_train/models/230904_161950_geneformer_30M_L6_emb256_SL2048_E3_B12_LR0.001_LSlinear_WU10000_Oadamw_DS4/checkpoint-10", "/grand/GeomicVar/rbr7/Geneformer/cancer_cellxgene_datasets/cancer_corpus/combined_6M_shuffled.dataset/", "./output_untrained","breast_cell_type")
