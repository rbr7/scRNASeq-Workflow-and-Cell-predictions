...
# data = lp.connect("/lus/grand/projects/GeomicVar/rbr7/Geneformer/cancer_cellxgene_datasets/glioblastoma/local.with_filter.glioblastoma.loom")
data = lp.connect("/lus/grand/projects/GeomicVar/rbr7/Geneformer/HNSCC_data/hnscc/hnscc_mod_B_filtered.loom")
