...
# adata = anndata.read_loom("/grand/GeomicVar/tarak/Geneformer/cancer_cellxgene_datasets/glioblastoma/local.with_filter.glioblastoma.loom")
adata = anndata.read_loom("/lus/grand/projects/GeomicVar/tarak/Geneformer/HNSCC_data/test.loom")
